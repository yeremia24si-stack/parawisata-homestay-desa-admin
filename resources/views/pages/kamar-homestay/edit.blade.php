...
@section('title', 'Edit Kamar Homestay')
        ...
        <div class="page-title">
            <div class="row">
                <div class="col-12 col-md-6 order-md-1 order-last">
                    <h3>Edit Kamar Homestay</h3>
                    <p class="text-subtitle text-muted">Form untuk mengubah data kamar homestay.</p>
                </div>
        ...
        <section class="section">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">Form Edit Kamar Homestay</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('kamar-homestay.update', $kamarHomestay->kamar_id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="text" class="form-control @error('nama_kamar') is-invalid @enderror" 
                                   id="nama_kamar" name="nama_kamar" value="{{ old('nama_kamar', $kamarHomestay->nama_kamar) }}" required>
                            @error('nama_kamar')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('kapasitas') is-invalid @enderror" 
                                           id="kapasitas" name="kapasitas" value="{{ old('kapasitas', $kamarHomestay->kapasitas) }}" min="1" required>
                                    @error('kapasitas')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="number" class="form-control @error('harga') is-invalid @enderror" 
                                           id="harga" name="harga" value="{{ old('harga', $kamarHomestay->harga) }}" min="0" required>
                                    @error('harga')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            @php
                                $fasilitas = is_array($kamarHomestay->fasilitas_json) ? $kamarHomestay->fasilitas_json : [];
                            @endphp
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="fasilitas_json[]" 
                                               value="Kasur" id="kasur" {{ in_array('Kasur', $fasilitas) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="fasilitas_json[]" 
                                               value="Lemari" id="lemari" {{ in_array('Lemari', $fasilitas) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="fasilitas_json[]" 
                                               value="AC" id="ac_kamar" {{ in_array('AC', $fasilitas) ? 'checked' : '' }}>
                                ...
                                <div class="col-md-3">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" name="fasilitas_json[]" 
                                               value="Kamar Mandi Dalam" id="km" {{ in_array('Kamar Mandi Dalam', $fasilitas) ? 'checked' : '' }}>
                        ...
                        <div class="form-group mb-3">
                            ...
                            @if($kamarHomestay->media)
                                <div class="mb-2">
                                    <img src="{{ asset('storage/' . $kamarHomestay->media) }}" alt="Current" width="150" class="rounded">
